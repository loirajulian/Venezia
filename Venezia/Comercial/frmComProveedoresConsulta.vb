...
Public Class frmComProveedoresConsulta
    ...
    Private Sub SubSetCabecera()
        Try
            ...
            'Le agregue la columna  Direccion y amplie el espacio de ancho
            lvwConsulta.Columns.Add(New ColHeader("Direccion", 250, HorizontalAlignment.Left, True))
    ...
    Private Sub SubCargarGrilla()
        ...
        Try
            ...
            For Each lProveedor In lArrayLiq
                ...
                'Le pedi que complete en la tabla tambien los datos de Domicilio
                lItem.SubItems.Add(lProveedor.Domicilio)
    ...
    Private Sub txtCriterioBusq_TextChanged(sender As Object, e As EventArgs) Handles txtCriterioBusq.TextChanged

    End Sub

    Private Sub lvwConsulta_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lvwConsulta.SelectedIndexChanged
