...
#End Region
    ...
    Private Sub ListasDePrecioToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ListasDePrecioToolStripMenuItem.Click
        MsgBox("No tiene permisos para ingresar a esta opcion.", MsgBoxStyle.Exclamation)
    End Sub

    Private Sub GestionDePedidosToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GestionDePedidosToolStripMenuItem.Click
        MsgBox("No tiene permisos para ingresar a esta opcion.", MsgBoxStyle.Exclamation)
    End Sub
    ...
    Private Sub PagosPendientesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PagosPendientesToolStripMenuItem.Click
        Dim Ventana As New frmTesoChkPagoPendte
        Dim F As Form
        Dim i As Integer
        Dim Cant As Integer = 0
        Try
            ...
            Ventana.Show()
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "frmPrincipal.PagosPendientesToolStripMenuItem_Click")
            gAdmin.Log.fncGrabarLogERR("Error en frmPrincipal.PagosPendientesToolStripMenuItem_Click:" & ex.Message)
        End Try
    End Sub
End Class