        ...
        Try
            ...
            If lDt.Rows.Count > 0 Then
                ...
                For Each lDr In lDt.Rows
                    ...
                    lArticulo.CodArt = lDr("CodArt")
                    lArticulo.Descripcion = lDr("Descripcion")
                    lArticulo.PcioCosto = lDr("PcioCosto")
                    lArticulo.PcioVta = lDr("PcioVta")
                    lArticulo.Caja = cCajaArticulos.GetCajaArticulosxCod(pAdmin, lDr("CodCaja"))
                    lArticulo.PorComis = lDr("PorComis")
                    lArticulo.Marca_Baja = EnuBinarioGetEnu(lDr("Marca_Baja"))
                    lArticulo.CalculaIVANdNc = EnuBinarioGetEnu(lDr("CalculaIVANdNc"))
                    lArticulo.ImpStk = EnuBinarioGetEnu(lDr("ImpStk"))
                    lArticulo.ArtacuStk = lDr("ArtacuStk")
                    lArticulo.ArtRelXCaja = lDr("ArtRelXCaja")
