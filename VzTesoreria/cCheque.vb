...
#End Region
    ...
    Public Shared Function Dat_RptTesoChkPagosPendte(ByRef pAdmin As VzAdmin.cAdmin, ByVal pCli As String, ByVal pFVtoD As Date, ByVal pTotalFact As Integer) As DataTable
        ...
        Try
            ...
            Sql = "Call vz_clientes_juli(0,'QUAIS S.A.');"

            Sql = Sql.Replace("#cli#", pCli.ToString)
            Sql = Sql.Replace("#fvtod#", VzAdmin.cFunciones.gFncConvertDateToString(pFVtoD, "YYYY/MM/DD"))
            Sql = Sql.Replace("#totalfact#", pTotalFact)
